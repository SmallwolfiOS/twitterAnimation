...
//            self.alpha = 0;
//        } completion:^(BOOL finished) {
////            self.backgroundColor =  [[UIColor colorWithRed:0.18 green:0.70 blue:0.90 alpha:1.0] colorWithAlphaComponent:0.1];;
...
-(void)addLayerToLaunchView
{
    ...
    layer.fillColor = [[UIColor yellowColor] colorWithAlphaComponent:1].CGColor;
...
{
    //// Color Declarations
    color1 = [UIColor colorWithRed: 0.521 green: 0.521 blue: 0.521 alpha: 1];
